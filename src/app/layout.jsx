...
export const metadata = {
  ...
  description: 'Premium wedding and event photography by Raju Das & Swarna Mukherjee Debnath. Capturing timeless, emotional stories and fine-art moments in Kolkata and across India.',
  keywords: ['Wedding Photography', 'Premium Wedding Photographer', 'Kolkata Wedding Photographer', 'Raju Das', 'Swarna Mukherjee Debnath', 'The Gallery Creation', 'Shoot Insights', 'Pre-Wedding Shoot'],
  authors: [{ name: 'Raju Das & Swarna Mukherjee Debnath' }],
  ...
  openGraph: {
    ...
    description: 'Premium wedding and event photography by Raju Das & Swarna Mukherjee Debnath. Capturing timeless, emotional stories and fine-art moments.',
